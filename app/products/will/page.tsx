...
export const metadata: Metadata = {
  ...
  description: "Create your legally binding will online. Name guardians for your children, distribute your assets, and protect your family. Starting at just $199. Couples plan available for $299.",
};
      ...
      <section className="relative py-24 bg-gradient-to-br from-primary to-primary-light overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book?product=will" className="inline-flex items-center gap-2 rounded-full bg-secondary px-8 py-4 text-lg font-semibold text-white hover:bg-accent transition-all duration-300 shadow-lg hover:shadow-xl">
              Get Started for $199
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
              </svg>
            </Link>
            <Link href="/book?product=will&couples=true" className="inline-flex items-center gap-2 rounded-full bg-white/10 px-8 py-4 text-lg font-semibold text-white ring-1 ring-white/20 hover:bg-white/20 transition-all duration-300">
              Couples Plan $299
            </Link>
          </div>
        </div>
