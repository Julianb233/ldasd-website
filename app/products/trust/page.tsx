...
export const metadata: Metadata = {
  ...
  description: "Create your living trust online and avoid probate. Keep your estate private, protect your assets, and ensure your wishes are honored. Attorney-backed, starting at $599. Couples plan available for $699.",
};
      ...
      <section className="relative py-24 bg-gradient-to-br from-primary to-primary-light overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/book?product=trust&couples=true" className="inline-flex items-center gap-2 rounded-full bg-white/10 px-8 py-4 text-lg font-semibold text-white ring-1 ring-white/20 hover:bg-white/20 transition-all duration-300">
              Couples Plan $699
            </Link>
          </div>
        </div>
